const info = [
  `
<div class="secuencial__container">
  <h3>Algoritmos secuenciales</h3>
  <p>La estructura secuencial es aquella en la que una acción (instrucción) sigue a otra en secuencia. Las tareas se
...
`,
  `
<div class="condicional__container">
  <h3>Algoritmos condicionales</h3>
  <p>Se evalúa la condición dada en la estructura SI, si es verdadera se ejecutan las acciones y si es falso continúa
...
<div class="for__container">
  <h3>Algoritmos Ciclicos(for)</h3>
  <p>Esta estructura iterativa indica un rango de valores exacto que una variable tendrá para
...
<div class="while__container">
  <h3>Algoritmos Ciclicos(While)</h3>
  <p>Estructura iterativa que indica un conjunto de instrucciones que se deben de repetir
